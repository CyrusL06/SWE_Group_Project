    ...
    validator: {
      $jsonSchema: {
        ...
        properties: {
          ...
          phone: { bsonType: 'string' },
          bikeType: { bsonType: 'string' },
          bikeSelections: { bsonType: 'object' },
          duration: { bsonType: 'string' },
          groupSize: { bsonType: 'int' },
          bikeQuantity: { bsonType: 'int' },
          time: { bsonType: 'string' },
          agreementConfirmed: { bsonType: 'bool' },
          status: { enum: ['confirmed', 'active', 'returned', 'cancelled', 'late', 'early return'] },
          startedAt: { bsonType: 'string' },
          expectedReturnAt: { bsonType: 'string' },
          actualReturnAt: { bsonType: 'string' },
          createdAt: { bsonType: 'date' },
          updatedAt: { bsonType: 'date' },
        },
      },
